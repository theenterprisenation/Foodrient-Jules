...
const ChiefOverview = () => {
  ...
  const displayRevenueData = revenueData.length > 0 ? revenueData : mockRevenueData;
  const displayOrderData = orderData.length > 0 ? orderData : mockOrderData;
  const displayUserDistribution = userDistribution.length > 0 ? userDistribution : mockUserDistribution;
  const displayCategoryData = categoryData.length > 0 ? categoryData : mockCategoryData;

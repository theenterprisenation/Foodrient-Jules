  ...
  const fetchUsers = async () => {
    try {
      ...
      const usersWithEmails = profiles?.map(profile => ({
        ...
        email: emails?.find(e => e.id === profile.id)?.email || 'N/A',
      ...
      <div className="mt-8 bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="prose prose-sm max-w-none text-gray-500">
          ...
          <ul>
            ...
            <li>Receive PEPS as bonuses for special promotions</li>
            <li>Participate in special events and activities</li>
          </ul>
          <p className="mt-2">
